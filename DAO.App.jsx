...
// inicializar o contrato editionDrop
  const editionDrop = useEditionDrop("0x131Ad87D893A627460d9B0492b54Bd6359396728");
  const token = useToken("0x44ad28c062A4Bf3E2ceFF78769eA293666e3Eab3");
  const vote = useVote("0xAdCAcFED7f19a0ec5A4E631991Af201A45535322");
...
const memberList = useMemo(() => {
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Seja bem vindo à PottersDAO, a DAO dos verdadeiros potterheads!!</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        ...
        <p>Parabéns por fazer parte desse clube de bruxos!</p>
        <div>
          <div>
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro da PottersDAO</h1>
      <button
        disabled={isClaiming}
        onClick={mintNft}
      >
